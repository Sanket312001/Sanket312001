...
✅ Backend Development - Created API endpoints for Applications, Created application Installer to download on different devices.
...
🗺️ Turn Key Cats – Procedural terrain generation using Perlin noise, Software Agents and ArcGIS



⚡ Tech Stack

Python | javaScript | Node.js | Express.js | SQL | R | Machine Learning | Deep Learning | Data Analytics | Tableau | Power BI | Apache Spark | Hadoop | AWS | PostgreSQL | MongoDB | Git

💼 Currently: Data Scientist @ Edify DataScience
